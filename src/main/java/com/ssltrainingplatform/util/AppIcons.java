...
public class AppIcons {
    ...
    private static String getPathContent(String name) {
        return switch (name) {
            ...
            case "tracking" -> "M12 22c5.523 0 10-4.477 10-10S17.523 2 12 2 2 6.477 2 12s4.477 10 10 10zm0-2a8 8 0 100-16 8 8 0 000 16z M12 7v10 M7 12h10";

            // Añade este caso dentro del método getPathContent en AppIcons.java
